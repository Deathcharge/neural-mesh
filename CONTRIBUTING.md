...
Thank you for your interest in contributing to neural-mesh! This document provides guidelines and instructions for contributing to the project.
...
1. **Fork the repository**
   ```bash
   # Go to https://github.com/Deathcharge/neural-mesh
   # Click "Fork" button
   ```

2. **Clone your fork**
   ```bash
   git clone https://github.com/YOUR_USERNAME/neural-mesh.git
   cd neural-mesh
   ```

3. **Add upstream remote**
   ```bash
   git remote add upstream https://github.com/Deathcharge/neural-mesh.git
   ```
...
- **Questions**: Use [GitHub Discussions](https://github.com/Deathcharge/neural-mesh/discussions)
- **Issues**: Use [GitHub Issues](https://github.com/Deathcharge/neural-mesh/issues)
